 ...
 * 
 *******************************/
if( !class_exists('QcIncreaseSalesConversionTracker') ){


	class QcIncreaseSalesConversionTracker{
		...
		public $plugin_text_domain = "qcld-increase-sales";
		public $add_cart_selector = ".single_add_to_cart_button";
		public $reached_cheackout_selector = ".checkout-button";
        public $report_button_parent= '.tabs-cross_sell-style-flip ul';
        public $report_button_dom = '<li><a href="#" id="qcld-con-tracker-button" data-toggle="modal"><i class="fa fa-line-chart" aria-hidden="true"></i></i><span>Conversion Report</span></a></li>';

        function init() {
            $this->relative_folder_url=QCLD_cross_sell_PLUGIN_URL . "conversion-tracker";
            if(is_admin() && !empty($_GET["page"]) && ($_GET["page"] == "qcld-increase-sales")){
            ...
            add_action( 'wp_ajax_qcld_increase_sales_con_tracker_insert', array(&$this,'con_tracker_insert') );
            add_action('wp_ajax_nopriv_qcld_increase_sales_con_tracker_insert', array(&$this,'con_tracker_insert'));
            ...
            //custom
            add_action( 'wp_ajax_qcld_increase_sales_con_tracker_custom_action_data', array(&$this,'con_tracker_custom_action_data') );
        }
        ...
        function include_admin_scripts( $hook ){
            ...
            wp_register_style('qlcd-con-tracker-datepicker', $this->relative_folder_url . '/admin/css/jquery-ui.css');
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title"><?php _e('Customer Conversion Tracker', $this->plugin_text_domain); ?></h4>
                        </div>
                        <div class="modal-body">
                            <ul class="nav nav-tabs">
                                <li><a data-toggle="tab" href="#yester"><?php _e('Yesterday', $this->plugin_text_domain); ?></a></li>
                                <li class="active"><a data-toggle="tab" href="#today"><?php _e('Today', $this->plugin_text_domain); ?></a></li>
                                <li><a data-toggle="tab" href="#7days"><?php _e('Last 7days', $this->plugin_text_domain); ?></a></li>
                                <li><a data-toggle="tab" href="#months"><?php _e('This Month', $this->plugin_text_domain); ?></a></li>
                                <li><a data-toggle="tab" href="#custom"><?php _e('Custom', $this->plugin_text_domain); ?></a></li>
                            </ul>
                            ...
                            <div class="tab-content">
                                <div id="yester" class="tab-pane fade">
                                    ...
                                    $reports=$this->qcld_increase_sales_con_tracker_get($sql);
                                    ?>
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th><?php _e('Add to Cart', $this->plugin_text_domain); ?></th>
                                            <th><?php _e('Reached Checkout', $this->plugin_text_domain); ?></th>
                                            <th><?php _e('Orders', $this->plugin_text_domain); ?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                            <td><?php echo $reports['cart_per'] ?>% (<?php echo $reports['cart_total'] ?>)</td>
                                            <td><?php echo $reports['checkouts_per'] ?>% (<?php echo $reports['checkouts_total'] ?>)</td>
                                            <td><?php echo $reports['orders_per'] ?>% (<?php echo $reports['orders_total'] ?>)</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <?php
                                ...
                                <div id="today" class="tab-pane fade in active">
                                    ...
                                    $today_reports=$this->qcld_increase_sales_con_tracker_get($today_sql);
                                    ?>
                                    <table class="table">
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><?php echo $today_reports['cart_per'] ?>% (<?php echo $today_reports['cart_total'] ?>)</td>
                                            <td><?php echo $today_reports['checkouts_per'] ?>% (<?php echo $today_reports['checkouts_total'] ?>)</td>
                                            <td><?php echo $today_reports['orders_per'] ?>% (<?php echo $today_reports['orders_total'] ?>)</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <?php
                                ...
                                <div id="7days" class="tab-pane fade">
                                    ...
                                    $week_reports=$this->qcld_increase_sales_con_tracker_get($week_sql);
                                    ?>
                                    <table class="table">
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><?php echo $week_reports['cart_per'] ?>% (<?php echo $week_reports['cart_total'] ?>)</td>
                                            <td><?php echo $week_reports['checkouts_per'] ?>% (<?php echo $week_reports['checkouts_total'] ?>)</td>
                                            <td><?php echo $week_reports['orders_per'] ?>% (<?php echo $week_reports['orders_total'] ?>)</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <?php
                                ...
                                <div id="months" class="tab-pane fade">
                                    ...
                                    $month_reports=$this->qcld_increase_sales_con_tracker_get($month_sql);
                                    ?>
                                    <table class="table">
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><?php echo $month_reports['cart_per'] ?>% (<?php echo $month_reports['cart_total'] ?>)</td>
                                            <td><?php echo $month_reports['checkouts_per'] ?>% (<?php echo $month_reports['checkouts_total'] ?>)</td>
                                            <td><?php echo $month_reports['orders_per'] ?>% (<?php echo $month_reports['orders_total'] ?>)</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <?php
                                ...
                                <div id="custom" class="tab-pane fade">
                                    <h4><?php _e('Pick dates for custom search', $this->plugin_text_domain); ?></h4>
                                    <div class="row">
                                    <div class="col-sm-4">
                                        <input type="text" name="con_traker_from" class="form-control" id="qcld_cross_con_traker_from" placeholder="<?php _e('From', $this->plugin_text_domain); ?>">
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" name="con_traker_from" class="form-control" id="qcld_cross_con_traker_to" placeholder="<?php _e('To', $this->plugin_text_domain); ?>">
                                    </div>
                                    <div class="col-sm-4">
                                        <button type="button" id="con_traker_sub"> <?php _e('Go', $this->plugin_text_domain); ?></button>
                                    </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-dismiss="modal"><?php _e('Close', $this->plugin_text_domain); ?></button>
                        </div>
                    </div>
        ...
        function qcld_increase_sales_con_tracker_get($sql){
            global $wpdb;
	...
	} //End of the class QcIncreaseSalesConversionTracker
...
add_action( 'init', 'Qcld_Increase_Sales_tracker_instance', 10, 3 );

if (!function_exists('Qcld_Increase_Sales_tracker_instance')) {
    function Qcld_Increase_Sales_tracker_instance(){
        $con_tracker_instance = new QcIncreaseSalesConversionTracker();
        $con_tracker_instance->init();
        if(!get_option('qcld_increase_sales_con_tracker')){
            $con_tracker_instance->qlcd_conversion_tracker_table();
            add_option('qcld_increase_sales_con_tracker',1);
