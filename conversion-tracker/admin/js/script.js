jQuery(function ($) {
	...
	$(document).ready(function () {
		...
		$('#qcld_cross_con_traker_from,#qcld_cross_con_traker_to').datepicker({ dateFormat: 'mm/dd/yy' });
    ...
    $(document).on('click','.modal-footer .btn.btn-danger',function (e) {

        $('#qcld-conversion-report-modal').modal('hide');
    ...
    function handle_chart_ajax() {
        ...
        var dateFrom=$('#qcld_cross_con_traker_from').val();
        var dateTo=$('#qcld_cross_con_traker_to').val();
        var data = {
