	    ...
	    if (!empty($show_sales_alert )) { ?>
	        <div id="qcld_cross_sell_notification">
	            ...
	            if (!empty($qcld_cross_sell_order_notification_sound )) { ?>
	                <audio id="qcld-woocommerce-notification-audio" muted="muted">
	                    <source src="<?php echo esc_url(QCLD_cross_sell_PLUGIN_URL); ?>assets/images/sell-notification.mp3" >
	                    </source>
	                </audio>
	            <?php } ?>
...
function qcld_cross_sell_last_sold_product($attributes){
